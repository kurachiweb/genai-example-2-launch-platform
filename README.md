...
- **FR-U-005**: システムは、ユーザーが自身のアクティビティ(プロフィール・投稿プロダクト・コメント・決済履歴等)のデータをエクスポートできる機能を提供しなければならない(DR-004に対応)
- **FR-U-006**: システムは、ユーザー登録時にメールアドレス確認機能を提供し、確認完了まで投稿機能を制限しなければならない
- **FR-U-007**: システムは、メールアドレスによるパスワード再設定機能を提供しなければならない
- **FR-U-008**: システムは、削除リクエスト受付後、DR-003に定める猶予期間内に個人データを完全に削除しなければならない
