...
- **FR-U-006**: システムは、ユーザー登録時にメールアドレス確認機能を提供し、確認完了まで投稿機能やUpvoteを制限しなければならない
- **FR-U-007**: システムは、メールアドレスによるパスワード再設定機能を提供しなければならない
- **FR-U-008**: システムは、削除リクエスト受付後、DR-002に定める猶予期間内に個人データを完全に削除しなければならない
- **FR-U-009**: システムは、ユーザーのメールアドレス確認完了時にDISIFY APIを使用して使い捨てメールアドレスかを判定しなければならない(LR-003に対応)
...
- **FR-A-007**: システムは、管理者がユーザー一覧またはユーザー詳細画面にて、FR-U-009による使い捨てメールアドレス判定結果を確認できる機能を提供しなければならない
