...
### skills/ecc/rules/typescript/ — TypeScript/JavaScript 固有ルール
...
### skills/ecc/rules/web/ — フロントエンド固有ルール
...
### skills/ecc/rules/react/ — React 固有ルール
...
React 18/19 と Next.js に特化したスキル群。`skills/ecc/rules/react/` のルールと、`react-reviewer`・`react-build-resolver` エージェント、`/react-*` コマンドと連携する。
