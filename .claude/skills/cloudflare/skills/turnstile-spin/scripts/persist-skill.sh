...
#
# Args:
#   --path <path>   SKILL.md destination, e.g. .claude/skills/cloudflare/skills/turnstile-spin/SKILL.md.
#                   The bundle is extracted into the parent directory of <path>,
#                   so scripts land at e.g. .claude/skills/cloudflare/skills/turnstile-spin/scripts/.
#
